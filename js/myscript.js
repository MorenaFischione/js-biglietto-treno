...
if (età < 18) {
    ...
    var rounded = Math.round((costoBigliettoScontatoVentiPerc  + Number.EPSILON) * 100) / 100;
    console.log(rounded);
} else if (età > 65) {
    ...
    //arrotondiamo a 2 decimali
    var rounded = Math.round((costoBigliettoScontatoQuarantaPerc  + Number.EPSILON) * 100) / 100;
    console.log(rounded);
} else {
    prezzoBiglietto;
};
